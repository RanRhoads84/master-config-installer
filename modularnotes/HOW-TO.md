...
- **Notes directory not found**: ensure ~/Documents/ModularNotes exists or update ~/.config/modularnotes/modularnotes.conf and restart your shell.# 🧈 ButterNotes - Complete HOW TO Guide
